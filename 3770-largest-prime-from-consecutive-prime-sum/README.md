<h2><a href="https://leetcode.com/problems/largest-prime-from-consecutive-prime-sum/description/">4085. Largest Prime from Consecutive Prime Sum</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code>.</p>
